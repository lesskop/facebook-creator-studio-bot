...
class CreatorStudioBot:
    ...
    def schedule_random_content_from_date(self, day, month, year, hour, minutes):
        ...
        for month in range(month_now, month_now + 4):
            ...
            for day in range(day_now, days_in_month[m] + 1):
                ...
                self.upload_content(random.choice(cats_video))

                # catch video error
                if self.xpath_exists('/html/body/div[4]/div/div/div/div[2]/div[1]/div/div[4]/div/div[1]/div'):
                    driver.find_element_by_xpath(
                    ...
                    if self.xpath_exists('/html/body/div[7]/div[2]/div/div/div/div/div[3]/div/div/div[2]/div/button'):
                        div = 'div[7]'
                    elif self.xpath_exists(
                            '/html/body/div[6]/div[2]/div/div/div/div/div[3]/div/div/div[2]/div/button'):
                        div = 'div[6]'
    ...
    def schedule_random_content(self, hour, minutes):
        driver = self.driver
